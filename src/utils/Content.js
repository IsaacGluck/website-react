const content = {
  website: {
    ...
    portfolio: {
      ...
      PainTrain: 'As I taught myself web development I took on the role of web master for my Ultimate Frisbee team. I built the site with raw <strong>HTML, CSS, Javascript</strong>, and the <strong>MaterializeCSS</strong> library. Check it out <a href="https://www.dartmouth.edu/~ultimate/home.html"  target="_blank">here</a>. ',
